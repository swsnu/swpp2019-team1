# Generated by Django 2.2.5 on 2019-11-05 15:41
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('match_thumbnail', models.ImageField(
                    blank=True, null=True, upload_to='thumbnail/')),
                ...
                ('category', models.ForeignKey(
                    on_delete=django.db.models.deletion.CASCADE, to='matchmaker.Category')),
                ('host_user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE,
                                                related_name='match_set', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            name='Participation',
            fields=[
                ...
                ('match', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE,
                                            related_name='participation_match', to='matchmaker.Match')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE,
                                           related_name='participation_user', to=settings.AUTH_USER_MODEL)),
            ],
        ),
    ]
